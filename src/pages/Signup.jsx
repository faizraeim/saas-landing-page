    ...
    <>
      ...
      <div className="flex min-h-screen flex-col justify-center px-6 py-12 lg:px-8 bg-[#4535af]" >
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <h2 className="mt-10 text-center text-xl/9 font-bold tracking-tight text-white">Sign up for an account</h2>
        </div>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <p className="mt-10 text-center text-sm/6 text-gray-400">
            Already a member?{' '}
            <a href="/login" className="font-semibold text-primary hover:text-white">
              Login
            </a>
          </p>
        </div>
